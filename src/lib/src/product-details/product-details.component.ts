...
export class ProductDetailsComponent implements OnInit {
    ...
    upload(file: any, signed_request: string, url: string, done: any) {
    ...
    delete(file: any, signed_request: string, url: string, done: any) {
        let xhr = new XMLHttpRequest();
    ...
    deleteImage(imageId: string): void {
        this.productImageService.deleteMainImage(imageId)
