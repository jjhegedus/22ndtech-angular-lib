...
This is a simple library for using 22ndtech services from Angular, implementing the
...
[travis-badge]: https://travis-ci.org/filipesilva/angular-22ndtech-angular-lib.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-22ndtech-angular-lib
...
1. Create a project folder (you can call it `22ndtech-angular-lib` and rename it later).
1. [Clone](#clone "Clone it from github") or [download](#download "download it from github") the **22ndtech Angular Library** into your project folder.
...
### Download
[Download the 22ndtech Angular Library seed](https://github.com/22ndtech/22ndtech-angular-lib/archive/master.zip)
...
The **22ndtech Angular Library** contains a similar structure to the [Quickstart seed](https://github.com/angular/quickstart).
...
The **22ndtech Angular Library** includes a directory called `integration` containing a standalone
...
Use your editor to search the project for all instances of `angular-22ndtech-angular-lib` and change it
